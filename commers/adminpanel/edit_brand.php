    ...
    if(isset($_GET['id'])) {
        ...
        if($id <= 0) {
            ...
            if($result) {
				...
				<div class="cn_head">Edit Brand</div>
				<div class="cn_cont">
					<p>
						<form action="edit_brand_process.php?id='.$row[brand_id].'" method="POST" enctype="multipart/form-data">
        					<fieldset>
                            	<p>
									...
									<input type="text" class="medium" name="newname" value="'.$row[brand_name].'" />
								</p>
        						<p>
									...
									<img src="pic/brand/'.$row[brand_img].'" width="100" />
