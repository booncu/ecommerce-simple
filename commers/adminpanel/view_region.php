...
function functionDel() {
	return confirm('Delete this region?');
}
</script>
...
<div class="cn_head">
	...
	<div style="float:right; width:40px; padding-right:20px;">
		<table style="font-size:12px; font-weight:bold;">
			...
			<td><span style="padding-top:1px;"><a href="add_region.php">Add</a></span></td>
			</tr>
		</table>
	</div>
		...
		<center><table border=0 cellpadding=2 cellspacing=2 class="altrowstable" id="alternatecolor"  width=100%>
			...
			echo '
                <tr>
					...
					<td><center><a href="edit_region.php?id='.$row[region_id].'"><img src="images/edit.png" /></a>  <a href="delete_region.php?id='.$row[region_id].'" onclick="return functionDel()"><img src="images/delete.png" /></a></center></td>
				</tr>
                ';
				$a = $a + 1;
				}
