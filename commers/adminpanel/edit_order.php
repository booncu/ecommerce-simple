    ...
    if(isset($_GET['id'])) {
        ...
        if($id <= 0) {
            ...
            if($result) {
					...
					<p>
						<form action="edit_order_status.php?id='.$row[order_id].'" method="POST" enctype="multipart/form-data">
        					<fieldset class="fieldset">
								...
								';
								$status = array("New Order","Process","Done");
								$a = 0;
							...
							<fieldset class="fieldset">
								...
								';
                                    ...
                                    ';
												...
												while ($c<3) {
													if ($service["$c"]!=$row[order_shipcomp]) {
														echo '
										...
										<p>
											...
											<select name="month">
												...
												while ($b<12) {
													...
													if ($b!=$montharr) {	
														echo '
                                    						<option value="'.$c.'">'.$monthname["$b"].'</option>
														';
													}
													$b = $b + 1;
												}
										...
										<input type="submit" value="Submit" name="submit" onclick="return changeService()" />
								</form>
								<p></p>
							</fieldset>
							<fieldset class="fieldset">
							...
							<fieldset class="fieldset">
								...
								while ($row3=mysqli_fetch_assoc($result3)) {
									...
									echo '
										...
										if ($row4[prod_pricedisc]!="") {
										$tt=($row4[prod_pricedisc]* $row3[orderdetails_sum]);
										}
										else {
										$tt=($row4[prod_price]* $row3[orderdetails_sum]);
										}										
										echo'
										<td><center> Rp. '.number_format("$tt","0",",",".").',-</center></td>
										</tr>
									';
									$total_pay["$a"] = $tt;
									$a = $a + 1;
								...
								echo '
									<tr>
										...
										<td><center><b>Rp '.number_format("$total",0,",",".").',-</b></center></td>
									</tr>
								</table>
							</fieldset>
                            <p></p>
                ...
                <p align="right"><a href="edit_order_print.php?id='.$row[order_id].'">Print Screen</a></p>
