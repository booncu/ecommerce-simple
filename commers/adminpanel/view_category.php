...
<div class="cn_head">
	<div style="float:left; width:100px;">List of Regions</div>
	<div style="float:right; width:40px; padding-right:20px;">
		<table style="font-size:12px; font-weight:bold;">
			<tr><td></td>
			<td><span style="padding-top:1px;"><a href="add_category.php"><img src="images/195.png" height="16px" />&nbsp;Add</a></span></td>
			</tr>
		</table>
	</div>
		...
		<center><table border=0 cellpadding=2 cellspacing=2 class="altrowstable" id="alternatecolor"  width=100%>
			...
			echo '
                <tr>
					...
					<td><center><img src="pic/category/'.$row[cat_img].'" width="100" /></center></td>
					<td><center><a href="edit_category.php?id='.$row[cat_id].'"><img src="images/edit.png" /></a>  <a href="delete_category.php?id='.$row[cat_id].'" onclick="return functionDel()"><img src="images/delete.png" /></a></center></td>
				</tr>
                ';
				$a = $a + 1;
				}
