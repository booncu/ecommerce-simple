    ...
    if(isset($_GET['id'])) {
        ...
        if($id <= 0) {
            ...
            if($result) {
				...
				<div class="cn_head">Edit Banner</div>
				<div class="cn_cont">
					<p>
						<form action="edit_banner_process.php?id='.$row[banner_id].'" method="POST" enctype="multipart/form-data">
        					<fieldset>
                            	<p>
									...
									<input type="text" class="medium" name="newname" value="'.$row[banner_name].'" />
								</p>
        						<p>
									...
									<img src="pic/banner/'.$row[banner_img].'" width="100" />
								...
								<p>
									...
									<input type="text" class="medium" name="newlink" value="'.$row[banner_link].'" />
								</p>
            				</fieldset>
