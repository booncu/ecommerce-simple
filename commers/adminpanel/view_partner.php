...
<div class="cn_head">
	<div style="float:left; width:100px;">List of Partners</div>
	<div style="float:right; width:40px; padding-right:20px;">
		<table style="font-size:12px; font-weight:bold;">
			<tr><td><img src="images/195.png" height="16px" /></td>
			<td><span style="padding-top:1px;"><a href="add_partner.php">Add</a></span></td>
			</tr>
		</table>
	</div>
		...
		<center><table border=0 cellpadding=2 cellspacing=2 class="altrowstable" id="alternatecolor"  width=100%>
			...
			echo '
                <tr>
					...
					<td><center>'.$row[partner_name].'</center></td>
					<td><center><img src="pic/partner/'.$row[partner_img].'" width="100" /></center></td>
					<td><center>'.$row[partner_sort].'</center></td>
					<td><center><a href="edit_partner.php?id='.$row[partner_id].'"><img src="images/edit.png" /></a>  <a href="delete_partner.php?id='.$row[partner_id].'" onclick="return functionDel()"><img src="images/delete.png" /></a></center></td>
				</tr>
                ';
				$a = $a + 1;
				}
