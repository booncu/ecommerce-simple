...
<div class="cn_head">
	<div style="float:left; width:100px;">List of Brands</div>
	<div style="float:right; width:40px; padding-right:20px;">
		<table style="font-size:12px; font-weight:bold;">
			<tr><td><img src="images/195.png" height="16px" /></td>
			<td><span style="padding-top:1px;"><a href="add_brand.php">Add</a></span></td>
			</tr>
		</table>
	</div>
		...
		<center><table border=0 cellpadding=2 cellspacing=2 class="altrowstable" id="alternatecolor"  width=100%>
			...
			echo '
                <tr>
					...
					<td><center><img src="pic/brand/'.$row[brand_img].'" width="100" /></center></td>
					<td><center><a href="edit_brand.php?id='.$row[brand_id].'"><img src="images/edit.png" /></a>  <a href="delete_brand.php?id='.$row[brand_id].'" onclick="return functionDel()"><img src="images/delete.png" /></a></center></td>
				</tr>
                ';
				$a = $a + 1;
				}
