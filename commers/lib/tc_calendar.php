...
class tc_calendar{
	...
	var $date_format = 'Y-M-d'; //format of date show in panel if $show_input is false
	...
	function writeCalendarContainer(){
		...
		echo("<IFRAME id=\"".$this->objname."_frame\" src=\"".$this->path."lib/calendar_form.php".$paramStr."\" frameBorder=\"0\" scrolling=\"no\" allowtransparency=\"true\" width=\"100%\" height=\"100%\" style=\"z-index: 100;\"></IFRAME>");
